...
exports.default = function () {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            null,
            _routers2.default.map(function (item, index) {
                return _react2.default.createElement(_reactRouterDom.Route, _extends({}, item, { key: index }));
            })
        )
    );
};
...
(0, _reactDom.hydrate)(_react2.default.createElement(_App2.default, null), document.getElementById('app')); // ssr时使用该方法
